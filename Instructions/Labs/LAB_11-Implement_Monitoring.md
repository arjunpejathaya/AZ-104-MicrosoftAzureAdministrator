...
### Review Questions
- What is the benefit that you get with the Upgrade Monitoring option for Virtual Machines?
- Which Azure Solution can create incidents based on Logs stored in Log Analytics?
- What is the pricing strategy for alerts configured in the Monitor?
