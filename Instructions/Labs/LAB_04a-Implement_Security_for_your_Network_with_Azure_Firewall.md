---
lab:
    title: '04a - Implement Network Security using Azure Firewall'
...
>**Note:** Please create a Windows Server 2019 Virtual Machine in the same region as the Firewall with the name **Srv-Work** with the Username **TestUser** and a password of your choice. In the **Select your ports** section, leave **RDP** checked.
...
5. In the **Enter your credentials** dialog box, log into the **Srv-Work** server virtual machine, by using your password.
